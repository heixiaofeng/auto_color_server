...
class Image2ImageDataset(chainer.dataset.DatasetMixin):
    ...
    def __init__(self, paths, root1='./input', root2='./terget', dtype=np.float32, leak=(0, 0), root_ref=None,
                 train=False):
...
class Image2ImageDatasetX2(Image2ImageDataset):
    ...
    def get_example(self, i, minimize=False, log=False, bin_r=0):
        ...
        return image1.transpose(2, 0, 1), image2.transpose(2, 0, 1), _image1.transpose(2, 0, 1), _image2.transpose(2, 0,
                                                                                                                   1)
